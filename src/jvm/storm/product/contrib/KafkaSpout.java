...
public class KafkaSpout extends BaseRichSpout {
    ...
    protected class PartitionManager {
        ...
        public void fail(Long offset) {
            ...
            //LOG.info("partition fail " + offset);
        ...
        public void commit() {
            ...
            //LOG.info("partition commit " + committedTo + "\n _committedTo" + _committedTo); 
            if(committedTo!=_committedTo) {
                _state.setData(committedPath(), new ZooMeta(_uuid, committedTo));          
                _committedTo = committedTo;
                //LOG.info("partition commit_1 " + committedPath() + " ZooMeta" + new ZooMeta(_uuid, committedTo));
            }
        }
    ...
    public void nextTuple() {
        for(int i=0; i<_managedPartitions.size(); i++) {
            ...
            //LOG.info("spout nexttuple" + _currPartitionIndex);
